...
//-----
#define	PROTOCOL_NETQUAKE_PQ	777
#define	PROTOCOL_NETQUAKE_QRACK	888
//#define PROTOCOL_NETQUAKE_RMQ	999
...
#define	U_ANGLE2		(1<<4)
#define	U_STEP		(1<<5)	//johnfitz -- was U_NOLERP, renamed since it's only used for MOVETYPE_STEP//#define	U_NOLERP	(1<<5)		// don't interpolate movement
#define	U_FRAME		(1<<6)
...
#define	U_LONGENTITY	(1<<14)// nehahra support
...
#define ENTALPHA_ZERO		0.2 //entity is invisible (lowest possible alpha)
...
//R00k: TODO: turn these into proper svc_ functions
#define pqc_nop			1
