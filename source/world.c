...
// touch linked edicts
	for (l = node->trigger_edicts.next ; l != &node->trigger_edicts ; l = next)
	{
		...
		{
			Con_DPrintf (1,"Warning: fixed up link in SV_TouchLinks\n");
			next = l->next;
		}
...
//MH: This will give you a correctly rotated bounding box on the server, and can be used instead of the rotation expansion in ID Quake
//http://forums.inside3d.com/viewtopic.php?p=35085#35085
...
// set the abs box
	...
	{
		SV_RotateBBoxToAbsMinMax (ent);//MH
	}
	else
	{
...
====================
*/
//optimized for recursion by LordHavoc
