...
cvar_t	snd_loadas8bit	= {"snd_loadas8bit", "0"};//R00k changed
...
qboolean OnChange_ambient_level (cvar_t *var, char *string)
{   
	Cvar_SetValue("ambient_level",atoi(string));
...
//ToDo:
//	ambient_sfx[AMBIENT_SLIME] = S_PrecacheSound ("ambience/slime.wav");
//	ambient_sfx[AMBIENT_LAVA] = S_PrecacheSound ("ambience/lava.wav");
